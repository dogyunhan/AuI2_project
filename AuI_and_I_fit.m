...
lb = horzcat([2.5 2.5 90], [2.97 2.94 180]); % lower bound
ub = horzcat([3.5 3.5 150], [3.05 3.02 180]); % upper bound
init_pars = lb;
...
function [chi2, theory_dSq_scaled] = objective_function(params, cfg)
    ...
    I3m = [params(4), params(5), params(6)];  % r1, r2, theta
