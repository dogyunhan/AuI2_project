...
init_pars = horzcat(2.8, [2.98, 2.98, 150], [2.50 2.50 180]); % AuI, I3m, GS
lb        = horzcat(2.5, [2.98, 2.98, 150], [2.49 2.49 180]);  % AuI, I3m, GS
ub        = horzcat(3.0, [3.02, 3.02, 180], [2.51 2.51 180]);  % AuI, I3m, GS
